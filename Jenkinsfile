...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.87.185:9000 \
              -Dsonar.login=2011d2478bf38cd9e340e430419002e1d6d67c2b"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#chidi-jenkins-cicd-pipeline-alerts', //update and provide your channel name
